...
@app_views.route(
    "/places/<string:place_id>/amenities", methods=["GET"], strict_slashes=False
)
def get_ameneties(place_id):
    """Retrieves the list of all reviews objects for a place"""
    ...
    if getenv("HBNB_TYPE_STORAGE") == "db":
        ...
        for amenity_id in place.aminity_ids:
            amenities_obj.append(storage.get(Aminity, aminity_id))
    amenities = []
